...
class Findermusic {
  static const MethodChannel _channel = const MethodChannel('findermusic');
  ...
  Findermusic setHandlePermissions(bool handlePermissions) {
    _handlePermissions = handlePermissions;
    return this;
  }

  Findermusic setExecuteAfterPermissionGranted(
